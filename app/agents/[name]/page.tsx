    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="rounded-lg border border-neutral-800/60 bg-neutral-900/40 p-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <div className="text-xs text-blue-400 font-medium mb-2">Sensing ({agent.skills.sensing.length})</div>
            <div className="flex flex-wrap gap-1.5">
              ...
              {agent.skills.sensing.length === 0 && (
                <span className="text-[10px] text-neutral-600">None</span>
              )}
            </div>
          </div>
          <div>
            <div className="text-xs text-rose-400 font-medium mb-2">Acting ({agent.skills.acting.length})</div>
            <div className="flex flex-wrap gap-1.5">
