...
export async function notifyInterneuronOfPulse(
  ...
  const message = [
    ...
    `   IMPORTANT: In your directive instructions, ask actuators to submit RICH artifacts — html dashboards, SVG charts, image links — not just plain text. Example: "...and submit the result as an html artifact with a styled dashboard showing the data."`,
    ``,
